    ...
    <div class="w-full p-6 sm:p-12 text-center flex flex-col justify-center min-h-screen">
        ...
        <div class="w-full max-w-md mx-auto">
            ...
            <p v-if="showWarning" class="mt-2 text-red-600 text-sm">
                Warning: Your master password is {{ strengthInfo.label }}.
            </p>
        </div>
        ...
        <p class="text-sm text-blue-800 text-center pt-3 max-w-xl mx-auto">
            Your master password is the primary encryption key for securing all of your data.
            The robot avatar above will be unique to your password - it helps you visually
