...
import { 
  ...
  Copy, Check, Trash, Plus, Lock, Key, Mail, Globe, AlertCircle 
...
const loadPasswords = async () => {
  try {
    ...
    totalPasswords.value = await db.passwords
      .filter(password => !password.deleted_at)
      .count();
  } catch (error) {
...
<template>
  <div class="min-h-screen bg-gray-100 p-8">
    <div class="m-auto container">
      ...
      <div 
        v-if="showAddForm" 
        class="mb-8 p-6 bg-white rounded-xl shadow-lg transition-all duration-300 ease-in-out"
      >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="relative">
            <input 
              v-model="newPassword.totpSecret" 
        ...
        <button 
          @click="addPassword" 
          class="mt-6 bg-blue-500 text-white px-6 py-3 rounded-lg w-full hover:bg-blue-600 transition-colors flex items-center justify-center"
        >
        ...
        >
          <div class="p-6">
            <div class="flex justify-between items-start mb-4">
              ...
              <button 
                @click="removePassword(password.id)" 
            ...
            <div class="flex items-center space-x-2 mb-4">
              <div class="relative flex-grow">
                ...
                <div class="absolute right-2 top-1/2 transform -translate-y-1/2 flex items-center space-x-1">
                  ...
                  <button 
                    @click="copyToClipboard(password.password, 'password-' + password.id)" 
              ...
              <div class="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div class="flex items-center space-x-2">
                    ...
                    <button 
                      @click="copyToClipboard(password.totp30, 'totp30-' + password.id)" 
                      class="text-blue-500 hover:text-blue-700 p-1 rounded-full hover:bg-blue-100 transition-colors"
                    >
                ...
                <div>
                  ...
                  <div class="flex items-center space-x-2">
                    ...
                    <button 
                      @click="copyToClipboard(password.totp60, 'totp60-' + password.id)" 
                      class="text-blue-500 hover:text-blue-700 p-1 rounded-full hover:bg-blue-100 transition-colors"
                    >
      ...
      <!-- Empty State -->
      <p 
        v-if="passwords.length === 0 && !isLoading" 
